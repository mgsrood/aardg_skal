...
original_file: str = "Sales 2024-06-17.xlsx"
...
if date_extension:
    cleaned_report = f'/Users/maxrood/werk/codering/aardg/projecten/skal/massabalans/cleaned_sales_report_{date_extension.group()}.xlsx'
